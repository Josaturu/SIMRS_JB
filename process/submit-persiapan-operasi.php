    ...
    try {
        ...
        */
        ...
        if ($stmt->execute()) {
            ...
            header("Location: ../index.php?page=persiapan-operasi&no_rawat={$formData['no_rawat']}&kode_paket={$formData['kode_paket']}&tanggal={$formData['tanggal']}&jam_mulai={$formData['jam_mulai']}");
        } else {
